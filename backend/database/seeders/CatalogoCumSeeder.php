...
use App\Imports\Seeders\CatalogoCumImport;
use Illuminate\Database\Seeder;
use Maatwebsite\Excel\Facades\Excel;
use PhpOffice\PhpSpreadsheet\IOFactory;

class CatalogoCumSeeder extends Seeder
{
    public function run(): void
    {
        try {
            $filesPath = [
                database_path('db/55-TablaReferencia_CatalogoCUMs__1.xlsx'),
                database_path('db/55-TablaReferencia_CatalogoCUMs__2.xlsx'),
            ];
            ...
            foreach ($filesPath as $key => $path) {
                ...
                $import = new CatalogoCumImport($maxRecords);
