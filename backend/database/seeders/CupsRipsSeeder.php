...
use App\Imports\Seeders\CupsRipsImport;
use Illuminate\Database\Seeder;
use Maatwebsite\Excel\Facades\Excel;
use PhpOffice\PhpSpreadsheet\IOFactory;

class CupsRipsSeeder extends Seeder
{
    public function run(): void
    {
        try {
            $filesPath = [
                database_path('db/28-TablaReferencia_CUPSRips__1.xlsx'),
            ];
            ...
            foreach ($filesPath as $key => $path) {
                ...
                $import = new CupsRipsImport($maxRecords);
