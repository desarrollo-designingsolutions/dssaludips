...
class RipsTipoDiagnosticoPrincipalVersion2Seeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        try {
            $sheet = $excelService
                ->getSpreadsheetFromExcel(database_path('db/TablaReferencia_RIPSTipoDiagnosticoPrincipalVersion2__1.xlsx'))
