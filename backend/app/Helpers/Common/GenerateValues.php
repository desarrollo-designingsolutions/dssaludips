...
class GenerateValues
{
    public static function getPaginatedDataRedis(Request $request, $invoiceId, $model, $redisPrefix = 'invoice')
    {
        ...
        $paginator = new LengthAwarePaginator(
            ...
            $perPage,
            $page,
            ['path' => "/api/invoices/{$invoiceId}/paginatedUsers"]
        );
    ...
    public static function validateFilingStatus($filing_id)
    {
    ...
    public static function filingOld_deletefileZipData($data)
    {
    ...
    public static function filingOld_openFileZip($fileZip)
    {
    ...
    public static function filingOld_buildAllDataTogether($files)
    {
        $dataArrayAF = [];
        $dataArrayAC = [];
        $dataArrayUS = [];
        ...
        $dataArrayAF = $dataArrayAF->map(function ($item) use ($dataArrayAC, $dataArrayUS, $dataArrayAP, $dataArrayAM, $dataArrayAU, $dataArrayAH, $dataArrayAN, $dataArrayAT) {
            ...
            self::filingOld_invoiceUserServices($dataArrayAC, $dataArrayUS, $item, 'consultas');

            self::filingOld_invoiceUserServices($dataArrayAP, $dataArrayUS, $item, 'procedimientos');

            self::filingOld_invoiceUserServices($dataArrayAM, $dataArrayUS, $item, 'medicamentos');

            self::filingOld_invoiceUserServices($dataArrayAU, $dataArrayUS, $item, 'urgencias');

            self::filingOld_invoiceUserServices($dataArrayAH, $dataArrayUS, $item, 'hospitalizacion');

            self::filingOld_invoiceUserServices($dataArrayAN, $dataArrayUS, $item, 'recienNacidos');

            self::filingOld_invoiceUserServices($dataArrayAT, $dataArrayUS, $item, 'otrosServicios');
    ...
    public static function filingOld_invoiceUserServices($dataArray, $dataArrayUS, &$invoice, $keyService)
    {
