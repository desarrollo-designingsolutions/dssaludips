...
<template>
  <div>
    <AppSelectRemote :key="selectKey" closable-chips class="mt-1" url="/selectInfiniteServiceVendor"
      :loading="isLoading" returnObject v-model="valueAppSelectRemote"
      @update:modelValue="emit('update:modelValue', $event)" arrayInfo="serviceVendors" clearable v-bind="{
        ...$attrs,
        id: elementId,
      }" :params="params">
      <!-- <template #append>
