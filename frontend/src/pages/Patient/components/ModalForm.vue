            ...
            <VRow>
              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Tipo de Documento" v-model="form.tipo_id_pisi_id"
                  url="/selectInfiniteTipoIdPisis" arrayInfo="tipoIdPisis" :requiredField="true" :rules="tipoIdRule"
                  clearable :itemsData="tipoIdPisis_arrayInfo" :firstFetch="false" :params="paramsSelect">
                </AppSelectRemote>
              </VCol>
              ...
              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Tipo de Usuario"
                  ...
                  :itemsData="ripsTipoUsuarioVersion2s_arrayInfo" :firstFetch="false" :params="paramsSelect">
                </AppSelectRemote>
              </VCol>

              <VCol cols="12" sm="4">
                <AppTextField clearable type="date" :requiredField="true" :error-messages="errorsBack.birth_date"
                  :rules="birthDateRule" v-model="form.birth_date" label="Fecha de Nacimiento"
              ...
              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Sexo" v-model="form.sexo_id"
                  ...
                  clearable :itemsData="sexos_arrayInfo" :firstFetch="false" :params="paramsSelect">
                </AppSelectRemote>
              </VCol>
              ...
              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Pais de Residencia"
                  ...
                  :rules="paisResidenciaRule" clearable :itemsData="paises_arrayInfo" :firstFetch="false"
                  :params="paramsSelect">
                </AppSelectRemote>
              </VCol>
              ...
              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Municipio de Residencia"
                  v-model="form.municipio_residency_id" url="/selectInfiniteMunicipio" arrayInfo="municipios" clearable
                  :itemsData="municipios_arrayInfo" :firstFetch="false" :params="paramsSelect">
                </AppSelectRemote>
              </VCol>

              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Zona Territorial de Residencia"
                  v-model="form.zona_version2_id" url="/selectInfiniteZonaVersion2" arrayInfo="zonaVersion2s" clearable
                  :itemsData="zonaVersion2s_arrayInfo" :firstFetch="false" :params="paramsSelect">
                </AppSelectRemote>
              </VCol>
              ...
              <VCol cols="12" sm="4">
                <AppSelectRemote :disabled="disabledFiledsView" label="Pais de Origen" v-model="form.pais_origin_id"
                  url="/selectInfinitePais" arrayInfo="paises" :requiredField="true" :rules="paisOrigenRule" clearable
                  :itemsData="paises_arrayInfo" :firstFetch="false" :params="paramsSelect">
                </AppSelectRemote>
              </VCol>
