...
const props = withDefaults(defineProps<FileUploadProps>(), {
  maxFileSizeMB: 5, // 5MB para archivos CSV
...
const getProgressMessage = (progress: number): string => {
  if (progress < 20) return "Iniciando la carga del archivo CSV...";
  if (progress < 40) return "Verificando la integridad del archivo CSV...";
  if (progress < 60) return "Subiendo el archivo CSV al servidor...";
          ...
          <div class="file-requirements mt-6">
            <v-card variant="tonal" color="info" class="pa-4">
              ...
              <div class="requirements-list">
                ...
                <div class="requirement-item">
                  <v-icon size="16" color="success" class="mr-2">tabler-check</v-icon>
                  <span class="text-body-2">Formato: CSV únicamente</span>
                </div>
                <div class="requirement-item">
                  <v-icon size="16" color="success" class="mr-2">tabler-check</v-icon>
  ...
  <VDialog v-model="successDialog" max-width="500px">
    ...
    <VCard>
      <v-card-text class="text-h5 text-center">
        ...
        <span>El archivo CSV se ha cargado correctamente.</span>
      </v-card-text>
