...
const props = withDefaults(defineProps<FileUploadProps>(), {
  maxFileSizeMB: 5, // 5MB para archivos XML
...
const getProgressMessage = (progress: number): string => {
  if (progress < 20) return "Iniciando la carga del archivo XML...";
  if (progress < 40) return "Verificando la integridad del archivo XML...";
  if (progress < 60) return "Subiendo el archivo XML al servidor...";
  ...
  const uploadSingleFile = async (file: FileUpload) => {
    ...
    try {
      ...
      await new Promise((resolve, reject) => {
        ...
        xhr.open('POST', `${api.defaults.baseURL}/ripInvoice/uploadFileXml`);
      ...
      <div>
        <VToolbar color="primary">
          <VToolbarTitle>
            ...
            Carga de archivo XML {{ invoice?.invoice_number ? `- Factura: ${invoice.invoice_number}` : '' }}
          </VToolbarTitle>
        </VToolbar>
      </div>
        ...
        <div v-if="currentStep === 'upload'" class="upload-section">
          <div ref="dropzone" class="modern-dropzone" :class="{ 'dragover': isDragOver }" @drop="onDrop"
            ...
            <div class="dropzone-content">
              ...
              <h3 class="text-h5 font-weight-medium mb-2">Arrastra tu archivo XML aquí</h3>
          ...
          <div class="file-requirements mt-6">
            <v-card variant="tonal" color="info" class="pa-4">
              ...
              <div class="requirements-list">
                ...
                <div class="requirement-item">
                  <v-icon size="16" color="success" class="mr-2">tabler-check</v-icon>
                  <span class="text-body-2">Formato: XML únicamente</span>
                </div>
                <div class="requirement-item">
                  <v-icon size="16" color="success" class="mr-2">tabler-check</v-icon>
  ...
  <VDialog v-model="successDialog" max-width="500px">
    ...
    <VCard>
      <v-card-text class="text-h5 text-center">
        ...
        <span>El archivo XML se ha cargado correctamente.</span>
      </v-card-text>
